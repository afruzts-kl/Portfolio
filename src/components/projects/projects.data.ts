...
export const projects: Project[] = [
  {
    ...
    status: "experimental",
    githubUrl: "https://github.com/zeyroxviper/jarvis-ai-assistant",
    screenshots: [],
    startDate: "2023-06",
    endDate: "2024-12",
    featured: true,
  },
  {
    ...
    status: "active",
    githubUrl: "https://github.com/zeyroxviper/healthcare-management",
  ...
  },
  {
    ...
    status: "active",
    githubUrl: "https://github.com/zeyroxviper/minecraft-infrastructure",
    screenshots: [],
    startDate: "2022-01",
    featured: true,
  },
  {
    ...
    status: "archived",
    githubUrl: "https://github.com/zeyroxviper/esp8266-experiments",
    screenshots: [],
    startDate: "2023-01",
    endDate: "2024-06",
    featured: false,
  },
  {
    ...
    status: "building",
    githubUrl: "https://github.com/zeyroxviper/home-lab",
    screenshots: [],
    startDate: "2024-08",
    featured: true,
  },
